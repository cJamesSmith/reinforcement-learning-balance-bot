...
class BalancebotEnv(gym.Env):
    ...
    def __init__(self, render=True):
        ...
        self._seed()
        # self.writer = SummaryWriter('tmp/tfb/')
        self.record_time = 0
        self.eps_reward = 0
        self.ave_reward = 0
    ...
    def step(self, action):
        ...
        if self._envStepCounter == 0:
            # self.writer.add_scalar('reward', self.ave_reward, global_step=self.record_time)
            self.eps_reward = 0
        self.eps_reward += reward
        self._envStepCounter += 1
        self.ave_reward = self.eps_reward / self._envStepCounter
    ...
    def _assign_throttle(self, action):
        ...
        vt = clamp(self.vt + action, -self.maxV, self.maxV)
        self.vt = vt
    ...
    def _compute_reward(self):
        ...
        return (1 - abs(cubeEuler[0])) -  abs(self.vt - self.vd)
